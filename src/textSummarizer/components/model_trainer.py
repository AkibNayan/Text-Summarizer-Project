...
# Define the Component for Model Training
class ModelTrainer:
    ...
    def train(self):
        ...
        model_pegasas = AutoModelForSeq2SeqLM.from_pretrained(
        ...
        # Save Model
        model_pegasas.save_pretrained(
            os.path.join(self.config.root_dir, "pegasas-samsum-model"))
        # Save Tokenizer
